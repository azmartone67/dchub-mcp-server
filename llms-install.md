...
infrastructure: 18,100+ data-center facilities across 170+ countries, 300+ markets
scored by the DC Hub Power Index (DCPI), 1,800+ tracked M&A deals, live ISO grid telemetry
...
82 tools including `search_facilities`, `rank_markets`, `get_grid_scoreboard`, and
