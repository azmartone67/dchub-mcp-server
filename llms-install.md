...
infrastructure: 15,300+ data-center facilities across 180+ countries, 300+ markets
scored by the DC Hub Power Index (DCPI), 1,600+ tracked M&A deals, live ISO grid telemetry
...
81 tools including `search_facilities`, `rank_markets`, `get_grid_scoreboard`, and
