...
npm-install. Connect with the URL `https://dchub.cloud/mcp` (90 tools, free
...
> you should see **90 tools** including `get_composite_site_score`,
...
- MCP manifest: `https://dchub.cloud/.well-known/mcp.json` (90 tools)
