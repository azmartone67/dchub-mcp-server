...
npm-install. Connect with the URL `https://dchub.cloud/mcp` (70 tools, free
...
> you should see **70 tools** including `get_composite_site_score`,
...
- MCP manifest: `https://dchub.cloud/.well-known/mcp.json` (70 tools)
