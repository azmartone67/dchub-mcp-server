...
npm-install. Connect with the URL `https://dchub.cloud/mcp` (86 tools, free
...
> you should see **86 tools** including `get_composite_site_score`,
...
- MCP manifest: `https://dchub.cloud/.well-known/mcp.json` (86 tools)
