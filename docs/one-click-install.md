...
npm-install. Connect with the URL `https://dchub.cloud/mcp` (88 tools, free
...
> you should see **88 tools** including `get_composite_site_score`,
...
- MCP manifest: `https://dchub.cloud/.well-known/mcp.json` (88 tools)
