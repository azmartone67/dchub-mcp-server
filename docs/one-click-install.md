...
npm-install. Connect with the URL `https://dchub.cloud/mcp` (91 tools, free
...
> you should see **91 tools** including `get_composite_site_score`,
...
- MCP manifest: `https://dchub.cloud/.well-known/mcp.json` (91 tools)
