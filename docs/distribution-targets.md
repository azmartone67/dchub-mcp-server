...
The technical + artifact foundation is done (83 tools, discoverable, provenance,
...
> 83 MCP tools at `dchub.cloud/mcp`** covering 20,100+ facilities in 170+ countries,
> live ISO grid telemetry, DCPI market verdicts, fiber, gas, 2,000+ M&A deals, plus
...
**Ask (all):** "List DC Hub — remote MCP, 83 tools, `dchub.cloud/mcp`. Category:
