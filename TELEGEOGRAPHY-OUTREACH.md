# TeleGeography — Partnership Outreach (draft, yours to send)

Context: TeleGeography = incumbent network / interconnection / colocation-pricing research (Data Center Research Service; ~1,500 site surveys; Market Connectivity Score = 45 data points/city; sells geocoded map data as JSON/GeoJSON to S3; enterprise annual license). DC Hub = live power/grid/gas/ISO + MCP-native, citable (CC-BY). Fit is COMPLEMENTARY, not competitive: their network/pricing ⊕ our power/energy. Frame peer-to-peer (Jonathan is CBRE DCS) — complementary supplier of the live power layer, not "we'll make you better."

Do NOT send via the assistant — these are yours to send from your own account.

---

## PRIMARY — partnership / complementary data (cold email)

**Subject:** DC Hub × TeleGeography — the live power layer for your DC research
...
Worth a 20-minute call to see if there's something here? Happy to send a live data sample first.

Best,
Jonathan
[title] · dchub.cloud · [phone/email]
...
- **Proof we're real/live:** dchub.cloud/mcp (82-tool MCP server, cited by ChatGPT/Claude/Gemini/Perplexity); 20,700+ facilities; DCPI 300+ markets; per-state gas pipeline/operator presence (the DCGI score was withdrawn 2026-08-08 rather than published wrong, and restored 2026-08-30 once all three terms were repaired); 10 ISOs.
...
> Mirrors the existing plays: CBRE (Pat Lynch) live-data partnership + DCD (Dan Loosemore) affiliate. Same "supply the live layer to an established research brand" motion.
