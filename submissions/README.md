...
**Source of truth:** `../server.json` + `../mcp-server.json` (81 tools).
**Live endpoint:** `https://dchub.cloud/mcp` (Streamable HTTP).
**Live server:** v2.9.3, 81 tools.
...
validated) and `../mcp-server.json` (81 tools). Live endpoint:
`https://dchub.cloud/mcp` (Streamable HTTP). Live server: **v2.9.3, 81 tools**
