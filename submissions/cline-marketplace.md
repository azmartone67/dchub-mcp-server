...
```json
{
  "id": "dchub",
  "name": "DC Hub — Data Center & Energy Intelligence",
  "description": "Live data-center & energy intelligence MCP: 15,300+ facilities, 300+ markets, 10 ISO grids, DCPI power index, DCGI gas index, interconnection queues, M&A, fiber, water & tax. 81 tools, query and cite (CC-BY-4.0). Free tier, no signup.",
  "homepage": "https://dchub.cloud",
...
- [ ] Open a PR titled "feat: add DC Hub MCP server (data-center & energy intelligence, 81 tools)".
