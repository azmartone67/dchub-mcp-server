...
| Skill | Description |
|---|---|
| [`dc-hub-data-center-intelligence`](./dc-hub-data-center-intelligence/SKILL.md) | Answer data-center, power/grid, site-selection, and M&A questions with **live** DC Hub data — 18,800+ facilities across 170+ countries, 300+ DCPI markets, 10 ISO grids, fiber, and 1,900+ tracked deals — instead of stale training data. Includes a tool-selection map and honest-attribution guidance. |
