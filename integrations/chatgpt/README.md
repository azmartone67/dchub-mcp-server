...
- **Description:** Data center market intelligence powered by DC Hub — facility search, energy pricing, M&A transactions, site scoring, and ESG analytics across 16,900+ facilities in 170+ countries.
...
|--------|----------|-------------|
| searchFacilities | /api/agent/facilities | Search 16,900+ facilities by country, state, city |
