...
• Full 38-tool MCP server: https://dchub.cloud/mcp
...
Confirm you can reach it, then answer: which U.S. data-center markets have the most available power for a 100 MW AI build?
```
