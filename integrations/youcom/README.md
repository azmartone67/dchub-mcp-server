...
If you're building on the You.com API, give your agent the same instructions and let it fetch the endpoints above, or register them as tools (see [`../openrouter/tools.json`](../openrouter/tools.json) for ready function specs). For the full 85 tools, point an MCP client at `https://dchub.cloud/mcp`.
