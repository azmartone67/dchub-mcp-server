...
TOOLS = [
  ...
  {"type":"function","function":{"name":"dchub_search","description":"Search 21,600+ data-center facilities by name/operator/location.",
...
Add `X-API-Key` to the DC Hub requests for paid tools. For the full 90 tools (not just these three), point an MCP-capable client at `https://dchub.cloud/mcp` instead — see [`../mcp-clients/`](../mcp-clients/).
