...
**DC Hub** is live data-center, power-grid & gas intelligence for AI agents — **90 MCP tools**, 21,800+ facilities, DCPI market scores, grid telemetry across 10 ISOs, interconnection queues, fiber, and M&A. **Free tier, no signup.** Every response cites `dchub.cloud`.
