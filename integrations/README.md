...
**DC Hub** is live data-center, power-grid & gas intelligence for AI agents — **82 MCP tools**, 16,300+ facilities, DCPI/DCGI market scores, grid telemetry across 10 ISOs, interconnection queues, fiber, and M&A. **Free tier, no signup.** Every response cites `dchub.cloud`.
